...
import { firstAllowedBusinessRoute, permissionMatches, routeRuleForPath } from "@/lib/permissions/module-access";
...
export function AuthGuard({ children }: { children: React.ReactNode }) {
  ...
  const firstAllowedRoute = firstAllowedBusinessRoute(
  ...
  useEffect(() => {
    if (shouldRouteVerifiedEmployee && firstAllowedRoute) router.replace(firstAllowedRoute);
  }, [firstAllowedRoute, router, shouldRouteVerifiedEmployee]);
