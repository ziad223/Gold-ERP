...
export interface GoldPurchaseDraft {
  ...
  businessStatus?: "DRAFT" | "VALIDATED" | "POSTED" | "REVERSED";
  governanceStatus?: "NONE" | "PENDING" | "APPROVED" | "REJECTED";
  version: number;
  notes?: string | null;
  ...
  totalGoldValue?: number | string | null;
    totalPayableToCustomer?: number | string | null;
...
export interface GoldPurchaseApprovalRequest {
  ...
  version: number;
  /** Server-derived actionability; persisted approval history is separate. */
  actionable?: boolean;
  actionBlockedCode?: string | null;
  linkedBusinessStatus?: "DRAFT" | "VALIDATED" | "POSTED" | "REVERSED" | string | null;
}
