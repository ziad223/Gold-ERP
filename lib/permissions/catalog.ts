...
const EXACT_LABELS: Record<string, Partial<PermissionMeta>> = {
  ...
  "gold.manage_pricing_policy": { label: { ar: "إدارة قواعد تسعير الذهب", en: "Manage Gold Pricing Policies" }, description: { ar: "إنشاء وتفعيل قواعد تسعير الذهب وإدارة مصدر السوق", en: "Create and activate gold pricing policies and manage market source" }, sensitivity: "level_2" },
};
...
export const KNOWN_PERMISSION_CODES = [
  ...
  "audit.view", "gold.view", "gold.update", "gold.manage_pricing_policy", "payroll.view", "payroll.manage",
