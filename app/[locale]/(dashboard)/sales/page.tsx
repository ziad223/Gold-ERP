      ...
      <PageHeader
        ...
        actions={
          <div className="flex flex-wrap gap-2">
            ...
            <Link href="/sales/customer-gold/drafts"><Button variant="secondary">{rtl ? "شراء الذهب من العميل (CGP)" : "Customer Gold Purchase (CGP)"}</Button></Link>
            <Link href="/sales/customer-gold/history"><Button variant="secondary">{rtl ? "مشتريات الذهب السابقة" : "Historical customer-gold purchases"}</Button></Link>
