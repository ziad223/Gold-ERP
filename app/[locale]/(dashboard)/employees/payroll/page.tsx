              ...
              <tbody className="divide-y divide-border">
                {attendance.map((a) => (
                  <tr key={a.id} className="hover:bg-table-row-hover">
                    ...
                    <td className="px-5 py-4">{a.checkIn ? formatTime(a.checkIn, "Asia/Dubai", locale) : "—"}</td>
                    <td className="px-5 py-4">{a.checkOut ? formatTime(a.checkOut, "Asia/Dubai", locale) : "—"}</td>
