...
function staticContract() {
  ...
  contains(authGuard, "Select an employee to begin", "Branch Account safe shell remains before Employee verification");
  assert.ok(!authGuard.includes('pathname === "/dashboard"') && !authGuard.includes('router.replace("/pos")'), "no dashboard to POS fallback remains");
