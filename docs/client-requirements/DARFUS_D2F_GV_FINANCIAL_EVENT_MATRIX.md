...
| Partial redemption | Approved allocation and rounding rules | Payment Engine | Same as redemption for applied amount | Actual invoice Tax Engine | allocation and remaining balance | Fail closed if rounding is unapproved |
